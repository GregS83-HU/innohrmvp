    ...
    try {
      ...
      if (response.ok) {
        ...
        const welcomeMessage: Message = {
          id: 'welcome',
          text: "Hello! 😊 I’m here to help you assess your well-being at work. This assessment is completely anonymous and confidential. We’ll take a few minutes to discuss different aspects of your professional life. Are you ready to begin?",
          isBot: true,
          timestamp: new Date()
        };
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-lg">
                You’ve completed your workplace well-being assessment!
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-6 text-white">
                ...
                <p className="text-blue-100">Your level of happiness at work</p>
              </div>

              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-4 text-gray-800">Detail by domain</h3>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              <p className="text-yellow-800 text-sm">
                <strong>Confidentiality :</strong> Your responses are completely anonymous and help improve overall well-being in the company.
              </p>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="flex flex-col items-center p-4 bg-purple-50 rounded-lg">
                ...
                <h3 className="font-semibold text-purple-800">Fast</h3>
            ...
            <p className="text-xs text-gray-500 mt-4">
              No personal data is collected • Only aggregated anonymous results
            </p>
          </div>
        </div>
      </div>
