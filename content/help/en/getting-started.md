...
order: 1
summary: "What the dashboard is and how to move between modules."
---

## What is the dashboard?

When you log in, you land on your company's dashboard at a URL like `/jobs/your-company-name`. This is your private workspace — nobody outside your company can see it, and it's separate from HRInno's public marketing site and the free, no-account Job Assistant tool.

The dashboard's home screen shows a "Welcome back" message and a grid of quick links to the tools your account has access to. What you see depends on your role:
...
Every module is reachable from the top navigation bar or the account menu in the header:
